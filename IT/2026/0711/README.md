...
>问题：连上VPN后，有时不能 pull 成功，有时能成功。估计是网络问题，不成功报以下错误：
```shell
...
- Sync Changes
>问题：连上VPN后，也不能 Sync Changes 成功。一次成功都没有过。报以下错误：
```shell
> git pull --tags origin main
fatal: unable to access 'https://github.com/maping/Language.git/': Failed to connect to github.com port 443 after 10793 ms: Couldn't connect to server
```
